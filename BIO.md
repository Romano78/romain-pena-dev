# Romain Pena Ruiz — Bio Reference

Source of truth for all site copy. Pull from here when writing or updating any section.
All copy must follow brand rules: first person, no buzzwords, confident but human.

---

## Background Facts (raw)

- 6+ years in web development, majority Shopify-focused
- Most recent role: Full Stack Developer at Field Office (Montreal) — June 2021 to October 2025
- Previous: Full Stack Web Developer at Beslogic Inc (Montreal) — 2019 to 2020
- Education: Le Wagon code bootcamp (2019), BA Psychology — Cal State Long Beach
- Based in Montreal, QC
- Available for retainer work

---

## Real Work (concrete, use these for credibility)

- Built a full Shopify storefront for a **major gaming brand** using the pre-Dawn framework, pixel-perfect from design files
- Extended a licensed merch storefront: custom cart, custom fulfillment app, Klaviyo integration, Google Tag Manager, REST API endpoints
- Built a custom **product sync app** automating daily inventory updates between an internal business system and Shopify
- Full-stack background: C#, ASP.NET Core, Angular, TypeScript at Beslogic
- Psychology degree — unusually strong sense of user behavior and why things feel right or wrong

---

## Skills Worth Naming on Site

**Shopify:** Theme development (pre-Dawn), custom sections, custom fulfillment apps, Klaviyo, Google Tag Manager, product sync automation

**Frontend:** JavaScript / TypeScript, React 19, Next.js 15/16, Liquid, Tailwind CSS v4, GSAP, Framer Motion, Lenis, split-type

**Backend & Integrations:** Supabase, REST API development, OpenAI API, Cloudinary, OCR integration

**Other:** Figma to code, multi-currency, UI component library authoring, Vercel
...
- "passionate about" — buzzword, on the banned list
- "innovative" / "results-driven" / "impactful" — generic, meaningless
- "seamless experiences" — overused
- "digital solutions" — agency-speak
- "Let's connect" — LinkedIn cliché
- Any third person — always first person on this site
